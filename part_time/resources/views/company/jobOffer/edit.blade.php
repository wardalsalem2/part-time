...
<div class="container py-5">
    ...
    <form method="POST" action="{{ route('company.job-offers.update', $jobOffer->id) }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title" value="{{ old('title', $jobOffer->title) }}" class="form-control"
                required>
        </div>
