...
Route::middleware(['role:2'])->prefix('company')->name('company.')->group(function () {
    ...
    Route::get('applications/{application}/download-cv', [CompanyJobApplicationController::class, 'downloadCv'])->name('applications.downloadCv');
    Route::post('/company/applications/{id}/set-pending', [CompanyJobApplicationController::class, 'setPending'])->name('applications.setPending');
    Route::get('/company/{job?}', [CompanyJobApplicationController::class, 'index'])->name('applications.applications');
    ...
    Route::post('/company/applications/{id}/reject-email', [CompanyJobApplicationController::class, 'sendRejectEmail'])->name('applications.sendRejectEmail');
    // --------------------------- Profile ---------------------------
...
//---------------------------- admin  companies ------------------------------------------------------
    Route::middleware(['role:3'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('notifications/mark-as-read/{id}', [NotificationAdminController::class, 'markAsRead'])->name('notifications.markAsRead');
    });
//------------------------------ admin jobOffer --------------------------------------------------------------------------
